...
| --- | --- | --- |
| `onFocus` | When a field receives focus, or when a page becomes active (see [Navigation Listener](/web/guides/navigation-listener)) | Track field focus events for analytics, validation, or UI updates; listen for page navigation |
...
| `onBlur` | When a field loses focus, or when a page stops being active (see [Navigation Listener](/web/guides/navigation-listener)) | Track field blur events for validation or cleanup operations; listen for page navigation |
...
- **Triggered when**: A field receives focus, or when a page becomes active (Navigation Listener)
- **Purpose**: Track field focus events for analytics, validation, or UI updates; listen for page navigation

**Navigation Listener:** When the active page changes, `onFocus` is also called with `type: 'page.focus'` and a full `page` object. See [Navigation Listener](/web/guides/navigation-listener) for details and payload shape.
...
- **Triggered when**: A field loses focus, or when a page stops being active (Navigation Listener)
- **Purpose**: Track field blur events for validation or cleanup operations; listen for page navigation

**Navigation Listener:** When the active page changes, `onBlur` is also called with `type: 'page.blur'` and the page that is leaving. See [Navigation Listener](/web/guides/navigation-listener) for details and payload shape.
