...
**No matches?** You are not affected by this advisory and can stop here.
...
**A match?** Continue to the next section. The affected versions execute code at import time, so an install alone is enough — see [If you installed or imported an affected version](#if-you-installed-or-imported-an-affected-version).
