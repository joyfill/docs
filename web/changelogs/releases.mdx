...
- **Conditional Logic on Columns:** You can now apply conditional logic to table and collection columns, allowing columns to show or hide based on field values or other column values within the same row. (**NO-1919**)
