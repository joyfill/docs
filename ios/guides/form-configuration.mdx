...
Navigate to specific pages or fields programmatically using the `goto` function.

### Navigate to Page or Field
...
| Parameter | Type | Default | Description |
| --- | --- | --- | --- |
| `path` | `String` | required | Navigation path in format `"pageId"` or `"pageId/fieldPositionId"` |
...
- **Page + Field navigation**: Navigates to the page and automatically scrolls to bring the target field into view
