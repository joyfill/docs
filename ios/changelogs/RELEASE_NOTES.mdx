...
## What's Changed
**Fixed**
* Collection crash on cross-schema row navigation — fixed a crash that occurred when navigating to a row belonging to a different schema within the same collection


**Full Changelog**: https://github.com/joyfill/components-swift/compare/3.0.0-rc14...3.0.0-rc15
