...
* Table/Collection: Added support for cell-level focus and blur events
* Added filtering support for date/time columns in Table and Collection

Fixed
* Improved form loading time for large templates by optimizing schema validation.


**Full Changelog**: https://github.com/joyfill/components-swift/compare/3.0.0-rc12...3.0.0-rc13
