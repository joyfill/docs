...
val onField = documentEditor.decorators.list(fieldPath)
...
val onRow = documentEditor.decorators.list(rowPath)
...
documentEditor.decorators.add(rowPath, rowAction)
documentEditor.decorators.remove(rowPath, action = "duplicateRow")
```
...
val onColumn = documentEditor.decorators.list(columnPath)
...
documentEditor.decorators.add(columnPath, colAction)
documentEditor.decorators.update(columnPath, action = "uploadFile", decorator = colAction)
```
